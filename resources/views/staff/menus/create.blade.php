...
<div class="max-w-2xl mx-auto animate-fade-in-up">
    ...
    <div>
        ...
        <h1 class="font-display mt-2 text-3xl font-black text-stone-50 mb-6">Add Menu Item</h1>
    </div>
    ...
    <div class="rounded-2xl border border-stone-800 bg-stone-900 p-6">
        <form action="{{ route('staff.menus.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
