...
<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex items-center gap-4">
        ...
        <h1 class="text-3xl font-extrabold text-gray-900">Add Menu Item</h1>
    </div>
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <form action="{{ route('staff.menus.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" name="price" value="{{ old('price') }}" required min="0" step="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
